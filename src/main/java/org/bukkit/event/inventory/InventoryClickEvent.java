...
public class InventoryClickEvent extends InventoryEvent implements Cancellable {
    ...
    public enum ClickAction {
         ...
         * <p>
         * DEFAULT behavior:
         * The slot is added to the PaintEvent's queue if the mouse button is consistent.
         * <p>
         * ALLOW behavior:
         * The slot is forcibly added to the PaintEvent's queue, even if this is a right-click drag.
         * <p>
         * DENY behavior:
         * The slot is not added to the PaintEvent.
         */
        DRAG_LEFT,
        /**
         ...
         * <p>
         * DEFAULT behavior:
         * The slot is added to the PaintEvent's queue.
         * <p>
         * ALLOW behavior:
         * The slot is forcibly added to the PaintEvent's queue, even if this is a left-click drag.
         * <p>
         * DENY behavior:
         * The slot is not added to the PaintEvent.
         */
         ...
         * <p>
         * DEFAULT behavior:
         * A single item is dropped from the clicked stack. If the slot is a crafting result, one result is dropped.
         * <p>
         * DENY behavior:
         ...
         * <p>
         * DEFAULT behavior:
         * The clicked stack is dropped on the ground. If the slot is a crafting result, one result is dropped.
         * <p>
         * DENY behavior:
         * No items are dropped.
         */
